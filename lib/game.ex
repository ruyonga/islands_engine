defmodule IslandsEngine.Game do
  ...
  defp win_check({:error, :action_out_of_sequence}, _opponent, _state) do
    {:reply, {:error, :action_out_of_sequence}}
  end
  ...
  defp set_island_coordinates_reply(reply, _player, _island, _coordinate, state) do
    {:reply, reply, state}
  end
